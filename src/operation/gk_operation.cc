...
GKOperation::GKOperation() : sending_queue_() {}

GKOperation::GKOperation(world_model::Robot *robot, vss::Ball *ball, bool *running, bool *status_changed) : robot_(robot), ball_(ball),
...
void GKOperation::setConfigurations() {
    ...
    field_line_.setMinY(json_file["robots"]["goalkeeper"]["field_line"]["min_y"]);
    field_line_.setMaxY(json_file["robots"]["goalkeeper"]["field_line"]["max_y"]);
    max_ball_distance_ = json_file["robots"]["goalkeeper"]["max_ball_distance"];
    max_velocity_ = json_file["robots"]["goalkeeper"]["max_velocity"];
}
