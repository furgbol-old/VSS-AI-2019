...
#include "operations/centerback_operation.h"


namespace vss_furgbol {
namespace operations {

CenterbackOperation::CenterbackOperation(vss::Ball *ball, world_model::Robot *robot, int side, communications::SerialRepository *serial_repo) {
    ball_ = ball;
    robot_ = robot;
    side_ = side;
...
CenterbackOperation::~CenterbackOperation() {}

void CenterbackOperation::init() {
    configure("centerback");
    Operation::init();
}

void CenterbackOperation::setTarget() {
